    ...
    <div class="fixed-top bg-body-tertiary">
      ...
      <nav id="nav-main" class="navbar navbar-expand-lg">
        ...
        <div class="<?= bootscore_container_class(); ?>">
          ...
          <!-- Navbar Brand -->
          <a class="navbar-brand xs d-md-none" href="<?= esc_url(home_url()); ?>"><img src="<?= esc_url(get_stylesheet_directory_uri()); ?>/img/logo/EV-Supreme-Rectangular-Logo-1-removebg-preview.png" alt="logo" class="logo xs"></a>
          <a class="navbar-brand md d-none d-md-block" href="<?= esc_url(home_url()); ?>"><img src="<?= esc_url(get_stylesheet_directory_uri()); ?>/img/logo/EV-Supreme-Rectangular-Logo-1-removebg-preview.png" alt="logo" class="logo md"></a>
